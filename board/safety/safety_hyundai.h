...
const CanMsg HYUNDAI_TX_MSGS[] = {{832, 0, 8}, {1265, 0, 4}, {1157, 0, 4}, {832, 1, 8},{1265, 1, 4}, {1265, 2, 4}, {593, 2, 8}, {1057, 0, 8}, {790, 1, 8}, {912, 0, 7}, {912,1, 7}, {1268, 0, 8}, {1268,1, 8}};
...
static int hyundai_tx_hook(CAN_FIFOMailBox_TypeDef *to_send) {
  ...
  if (addr == 790) {if (OP_EMS_live < 1) {puts("  OP Ems live: forwarding to Car stopped"); puts("\n");} OP_EMS_live = 20;}
